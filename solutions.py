...
class DoubleSolution(SolutionType):
    ...
    ...   answer_pattern = '___',
    ...   solution1 = Anagram('Lap dancing', '<target> dancing', 'Lap', 'PAL'),
    ...   solution2 = Definition('friend', 'PAL'),
    ...   answer = 'PAL'
    ... )
    DoubleSolution(clue='Lap dancing friend', answer_pattern='___', solution1=Anagram(clue='Lap dancing', indicator='<target> dancing', target='Lap', answer='PAL'), solution2=Definition(clue='friend', answer='PAL'), answer='PAL')
